...
from src.mcp_modelservice_sdk.src.app_builder import SessionToolCallCache, set_current_session_id
...
def test_cache_functionality():
    ...
    print("📋 Test 6: Back to session 'user123' - Same parameters as Test 2 (cache hit)")
    set_current_session_id("user123")
