...
from src.mcp_modelservice_sdk.src.app_builder import create_mcp_application, set_current_session_id
...
""")
    ...
    try:
        print("📋 Test 1: Creating MCP application with stateful + JSON response (cache enabled)")
        ...
        if hasattr(app.state, 'tool_call_cache'):
            ...
            print("❌ Cache was not created (this shouldn't happen in stateful + JSON mode)")
